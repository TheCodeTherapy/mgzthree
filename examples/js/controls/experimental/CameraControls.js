/**
 * Generated from 'examples/jsm/controls/experimental/CameraControls.js'
 */
...
(function (global, factory) {
	...
	var CameraControls = function ( object, domElement ) {
		...
		if ( domElement === undefined ) console.warn( 'CameraControls: The second parameter "domElement" is now mandatory.' );
		if ( domElement === document ) console.error( 'CameraControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.' );
