/**
 * Generated from 'examples/jsm/helpers/FaceNormalsHelper.js'
 */
...
(function (global, factory) {
	...
	function FaceNormalsHelper( object, size, hex, linewidth ) {
		...
		if ( objGeometry && objGeometry.isGeometry ) {
			...
			console.warn( 'FaceNormalsHelper: only THREE.Geometry is supported. Use THREE.VertexNormalsHelper, instead.' );
