...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('/home/marcogomez/projects/fork/mgzthree/examples/jsm/libs/chevrotain.module.min.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', '/home/marcogomez/projects/fork/mgzthree/examples/jsm/libs/chevrotain.module.min.js'], factory) :
	...
	var VRMLLoader = ( function () {
		...
		if ( typeof chevrotain_module_min_js.chevrotain === 'undefined' ) {
			...
			throw Error( 'VRMLLoader: External library chevrotain.min.js required.' );
			...
			parse: function ( data, path ) {
				...
				function buildNode( node ) {
					...
					switch ( nodeName ) {
						...
						default:
							console.warn( 'VRMLLoader: Unknown node:', nodeName );
							break;
				...
				function buildGroupingNode( node ) {
					...
					for ( var i = 0, l = fields.length; i < l; i ++ ) {
						...
						switch ( fieldName ) {
							...
							default:
								console.warn( 'VRMLLoader: Unknown field:', fieldName );
								break;
				...
				function buildIndexedFaceSetNode( node ) {
					...
					if ( coordIndex === undefined ) {
						...
						console.warn( 'VRMLLoader: Missing coordIndex.' );
