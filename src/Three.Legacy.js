...
export function Face4( a, b, c, d, normal, color, materialIndex ) {
	...
	console.warn( 'Face4 has been removed. A THREE.Face3 will be created instead.' );
...
export function PointCloud( geometry, material ) {
	...
	console.warn( 'PointCloud has been renamed to THREE.Points.' );
...
export function Particle( material ) {
	...
	console.warn( 'Particle has been renamed to THREE.Sprite.' );
...
export function ParticleSystem( geometry, material ) {
	...
	console.warn( 'ParticleSystem has been renamed to THREE.Points.' );
	return new Points( geometry, material );
...
export function PointCloudMaterial( parameters ) {
	...
	console.warn( 'PointCloudMaterial has been renamed to THREE.PointsMaterial.' );
...
export function ParticleBasicMaterial( parameters ) {
	...
	console.warn( 'ParticleBasicMaterial has been renamed to THREE.PointsMaterial.' );
	return new PointsMaterial( parameters );
...
export function ParticleSystemMaterial( parameters ) {
	...
	console.warn( 'ParticleSystemMaterial has been renamed to THREE.PointsMaterial.' );
	return new PointsMaterial( parameters );
...
export function Vertex( x, y, z ) {
	...
	console.warn( 'Vertex has been removed. Use THREE.Vector3 instead.' );
...
export function DynamicBufferAttribute( array, itemSize ) {
	...
	console.warn( 'DynamicBufferAttribute has been removed. Use new THREE.BufferAttribute().setUsage( THREE.DynamicDrawUsage ) instead.' );
...
export function Int8Attribute( array, itemSize ) {
	...
	console.warn( 'Int8Attribute has been removed. Use new THREE.Int8BufferAttribute() instead.' );
...
export function Uint8Attribute( array, itemSize ) {
	...
	console.warn( 'Uint8Attribute has been removed. Use new THREE.Uint8BufferAttribute() instead.' );
...
export function Uint8ClampedAttribute( array, itemSize ) {
	...
	console.warn( 'Uint8ClampedAttribute has been removed. Use new THREE.Uint8ClampedBufferAttribute() instead.' );
...
export function Int16Attribute( array, itemSize ) {
	...
	console.warn( 'Int16Attribute has been removed. Use new THREE.Int16BufferAttribute() instead.' );
...
export function Uint16Attribute( array, itemSize ) {
	...
	console.warn( 'Uint16Attribute has been removed. Use new THREE.Uint16BufferAttribute() instead.' );
...
export function Int32Attribute( array, itemSize ) {
	...
	console.warn( 'Int32Attribute has been removed. Use new THREE.Int32BufferAttribute() instead.' );
...
export function Uint32Attribute( array, itemSize ) {
	...
	console.warn( 'Uint32Attribute has been removed. Use new THREE.Uint32BufferAttribute() instead.' );
...
export function Float32Attribute( array, itemSize ) {
	...
	console.warn( 'Float32Attribute has been removed. Use new THREE.Float32BufferAttribute() instead.' );
...
export function Float64Attribute( array, itemSize ) {
	...
	console.warn( 'Float64Attribute has been removed. Use new THREE.Float64BufferAttribute() instead.' );
...
Object.assign( CurvePath.prototype, {
	...
	createPointsGeometry: function ( divisions ) {
		...
		console.warn( 'CurvePath: .createPointsGeometry() has been removed. Use new THREE.Geometry().setFromPoints( points ) instead.' );
	...
	createSpacedPointsGeometry: function ( divisions ) {
		...
		console.warn( 'CurvePath: .createSpacedPointsGeometry() has been removed. Use new THREE.Geometry().setFromPoints( points ) instead.' );
	...
	createGeometry: function ( points ) {
		...
		console.warn( 'CurvePath: .createGeometry() has been removed. Use new THREE.Geometry().setFromPoints( points ) instead.' );
...
export function ClosedSplineCurve3( points ) {
	...
	console.warn( 'ClosedSplineCurve3 has been deprecated. Use THREE.CatmullRomCurve3 instead.' );
...
export function SplineCurve3( points ) {
	...
	console.warn( 'SplineCurve3 has been deprecated. Use THREE.CatmullRomCurve3 instead.' );
...
export function Spline( points ) {
	...
	console.warn( 'Spline has been removed. Use THREE.CatmullRomCurve3 instead.' );
...
Object.assign( Spline.prototype, {
	...
	initFromArray: function ( /* a */ ) {
		...
		console.error( 'Spline: .initFromArray() has been removed.' );

	},
	getControlPointsArray: function ( /* optionalTarget */ ) {

		console.error( 'Spline: .getControlPointsArray() has been removed.' );

	},
	reparametrizeByArcLength: function ( /* samplingCoef */ ) {

		console.error( 'Spline: .reparametrizeByArcLength() has been removed.' );
...
export function AxisHelper( size ) {
	...
	console.warn( 'AxisHelper has been renamed to THREE.AxesHelper.' );
...
export function BoundingBoxHelper( object, color ) {
	...
	console.warn( 'BoundingBoxHelper has been deprecated. Creating a THREE.BoxHelper instead.' );
...
export function EdgesHelper( object, hex ) {
	...
	console.warn( 'EdgesHelper has been removed. Use THREE.EdgesGeometry instead.' );
...
export function WireframeHelper( object, hex ) {
	...
	console.warn( 'WireframeHelper has been removed. Use THREE.WireframeGeometry instead.' );
...
Object.assign( Loader.prototype, {
	...
	extractUrlBase: function ( url ) {
		...
		console.warn( 'Loader: .extractUrlBase() has been deprecated. Use THREE.LoaderUtils.extractUrlBase() instead.' );
...
export function XHRLoader( manager ) {
	...
	console.warn( 'XHRLoader has been renamed to THREE.FileLoader.' );
...
export function BinaryTextureLoader( manager ) {
	...
	console.warn( 'BinaryTextureLoader has been renamed to THREE.DataTextureLoader.' );
...
Object.assign( MathUtils, {
	...
	random16: function () {
		...
		console.warn( 'Math: .random16() has been deprecated. Use Math.random() instead.' );
		return Math.random();
	...
	nearestPowerOfTwo: function ( value ) {
		...
		console.warn( 'Math: .nearestPowerOfTwo() has been renamed to .floorPowerOfTwo().' );
	...
	nextPowerOfTwo: function ( value ) {
		...
		console.warn( 'Math: .nextPowerOfTwo() has been renamed to .ceilPowerOfTwo().' );
...
Object.assign( Geometry.prototype, {
	...
	computeLineDistances: function () {
		...
		console.error( 'Geometry: .computeLineDistances() has been removed. Use THREE.Line.computeLineDistances() instead.' );
...
Object.assign( Object3D.prototype, {
	...
	getWorldRotation: function () {
		...
		console.error( 'Object3D: .getWorldRotation() has been removed. Use THREE.Object3D.getWorldQuaternion( target ) instead.' );
...
Object.assign( Mesh.prototype, {
	...
	setDrawMode: function () {
		...
		console.error( 'Mesh: .setDrawMode() has been removed. The renderer now always assumes THREE.TrianglesDrawMode. Transform your geometry via BufferGeometryUtils.toTrianglesDrawMode() if necessary.' );
...
Object.defineProperties( Mesh.prototype, {
	...
	drawMode: {
		get: function () {
			...
			console.error( 'Mesh: .drawMode has been removed. The renderer now always assumes THREE.TrianglesDrawMode.' );
			return TrianglesDrawMode;

		},
		set: function () {

			console.error( 'Mesh: .drawMode has been removed. The renderer now always assumes THREE.TrianglesDrawMode. Transform your geometry via BufferGeometryUtils.toTrianglesDrawMode() if necessary.' );
...
Object.defineProperty( Skeleton.prototype, 'useVertexTexture', {
	...
	get: function () {
		...
		console.warn( 'Skeleton: useVertexTexture has been removed.' );
...
Object.defineProperty( Curve.prototype, '__arcLengthDivisions', {
	...
	get: function () {
		...
		console.warn( 'Curve: .__arcLengthDivisions is now .arcLengthDivisions.' );
...
Object.defineProperties( Light.prototype, {
	...
	shadowCameraVisible: {
		set: function () {
			...
			console.warn( 'Light: .shadowCameraVisible has been removed. Use new THREE.CameraHelper( light.shadow.camera ) instead.' );
...
Object.defineProperties( Raycaster.prototype, {
	...
	linePrecision: {
		get: function () {
			...
			console.warn( 'Raycaster: .linePrecision has been deprecated. Use .params.Line.threshold instead.' );
...
Object.defineProperties( InterleavedBuffer.prototype, {
	...
	dynamic: {
		get: function () {
			...
			console.warn( 'InterleavedBuffer: .length has been deprecated. Use .usage instead.' );
			return this.usage === DynamicDrawUsage;
...
Object.assign( ExtrudeBufferGeometry.prototype, {
	...
	getArrays: function () {
		...
		console.error( 'ExtrudeBufferGeometry: .getArrays() has been removed.' );

	},

	addShapeList: function () {

		console.error( 'ExtrudeBufferGeometry: .addShapeList() has been removed.' );

	},

	addShape: function () {

		console.error( 'ExtrudeBufferGeometry: .addShape() has been removed.' );
...
Object.defineProperties( Uniform.prototype, {
	...
	dynamic: {
		set: function () {
			...
			console.warn( 'Uniform: .dynamic has been removed. Use object.onBeforeRender() instead.' );
...
Object.defineProperties( MeshPhongMaterial.prototype, {
	...
	metal: {
		get: function () {
			...
			console.warn( 'MeshPhongMaterial: .metal has been removed. Use THREE.MeshStandardMaterial instead.' );
			return false;
...
Object.defineProperties( Audio.prototype, {
	...
	load: {
		value: function ( file ) {
			...
			console.warn( 'Audio: .load has been deprecated. Use THREE.AudioLoader instead.' );
			var scope = this;
	...
	startTime: {
		set: function () {
			...
			console.warn( 'Audio: .startTime is now .play( delay ).' );
...
ImageUtils.loadTexture = function ( url, mapping, onLoad, onError ) {
	...
	console.warn( 'ImageUtils.loadTexture has been deprecated. Use THREE.TextureLoader() instead.' );
...
ImageUtils.loadTextureCube = function ( urls, mapping, onLoad, onError ) {
	...
	console.warn( 'ImageUtils.loadTextureCube has been deprecated. Use THREE.CubeTextureLoader() instead.' );
...
ImageUtils.loadCompressedTexture = function () {
	...
	console.error( 'ImageUtils.loadCompressedTexture has been removed. Use THREE.DDSLoader instead.' );

};

ImageUtils.loadCompressedTextureCube = function () {

	console.error( 'ImageUtils.loadCompressedTextureCube has been removed. Use THREE.DDSLoader instead.' );
